...
namespace LatticeUtils.Core
{
    ...
    public static class CollectionUtils
    {
        ...
        public static ICollection<T> AsReadOnly<T>(ICollection<T> collection)
        {
            ...
            if (collection is LatticeUtils.Core.Collections.ReadOnlyCollection<T>)
            {
                return collection;
            }
            
            return new LatticeUtils.Core.Collections.ReadOnlyCollection<T>(collection);
        }
        ...
        public static IEnumerable<IGrouping<int, T>> PaginateIntoGroupings<T>(IEnumerable<T> enumerable, int pageSize)
        {
            ...
            {
                yield return new LatticeUtils.Core.Collections.Grouping<int, T>(pageCounter, page);
                pageCounter++;
            }
        }
